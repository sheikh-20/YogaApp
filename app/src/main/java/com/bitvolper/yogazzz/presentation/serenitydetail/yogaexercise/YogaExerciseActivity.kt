...
import com.bitvolper.yogazzz.presentation.serenitydetail.SerenityDetailApp
...
@AndroidEntryPoint
class YogaExerciseActivity: BaseActivity() {


    companion object {
        fun startActivity(activity: Activity?) {
            val intent = Intent(activity, YogaExerciseActivity::class.java)
